...
################################################################
# This is a generated script based on design: vck190_mipiRxSingle_hdmiTx
#
...
# source vck190_mipiRxSingle_hdmiTx_script.tcl
...
set design_name vck190_mipiRxSingle_hdmiTx
...
xilinx.com:hls:extractEFrames_accel:1.0\
xilinx.com:hls:hdrmerge_accel:1.0\
...
proc create_hier_cell_GT_Quad_and_Clk { parentCell nameHier } {
  ...
  set_property -dict [list \
    CONFIG.PORTS_INFO_DICT {LANE_SEL_DICT {unconnected {RX0 RX1 RX2 RX3} PROT0 {TX0 TX1 TX2 TX3}} GT_TYPE GTY REG_CONF_INTF APB3_INTF BOARD_PARAMETER { }} \
    CONFIG.PROT_OUTCLK_VALUES {CH0_RXOUTCLK 390.625 CH0_TXOUTCLK 148.5 CH1_RXOUTCLK 390.625 CH1_TXOUTCLK 148.5 CH2_RXOUTCLK 390.625 CH2_TXOUTCLK 148.5 CH3_RXOUTCLK 390.625 CH3_TXOUTCLK 148.5} \
...
proc create_hier_cell_mipi_csi_rx_ss { parentCell nameHier } {
  ...
  set_property CONFIG.IIC_FREQ_KHZ {400} $axi_iic_1_sensor
...
proc create_hier_cell_cap_pipe { parentCell nameHier } {
  ...
  set_property CONFIG.FIFO_DEPTH {8192} $axis_data_fifo_cap


  # Create instance: extractEFrames_accel_0, and set properties
  set extractEFrames_accel_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:extractEFrames_accel:1.0 extractEFrames_accel_0 ]

  # Create instance: hdrmerge_accel_0, and set properties
  set hdrmerge_accel_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:hdrmerge_accel:1.0 hdrmerge_accel_0 ]
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net Conn1 [get_bd_intf_pins s_axi_control] [get_bd_intf_pins extractEFrames_accel_0/s_axi_control]
  connect_bd_intf_net -intf_net Conn2 [get_bd_intf_pins s_axi_control1] [get_bd_intf_pins hdrmerge_accel_0/s_axi_control]
  ...
  connect_bd_intf_net -intf_net axis_data_fifo_cap_M_AXIS [get_bd_intf_pins axis_data_fifo_cap/M_AXIS] [get_bd_intf_pins extractEFrames_accel_0/in_ptr]
  ...
  # Create port connections
  connect_bd_net -net ap_rst_n_1 [get_bd_pins video_rst_n] [get_bd_pins axis_data_fifo_cap/s_axis_aresetn]
  ...
  connect_bd_net -net clk_wizard_0_clk_out3 [get_bd_pins video_clk] [get_bd_pins ISPPipeline_accel_0/ap_clk] [get_bd_pins axis_data_fifo_cap/s_axis_aclk] [get_bd_pins extractEFrames_accel_0/ap_clk] [get_bd_pins hdrmerge_accel_0/ap_clk] [get_bd_pins v_frmbuf_wr_0/ap_clk] [get_bd_pins v_proc_ss_0/aclk_axis] [get_bd_pins v_proc_ss_0/aclk_ctrl]
...
proc create_hier_cell_mipi_capture_pipe { parentCell nameHier } {
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net Conn1 [get_bd_intf_pins s_axi_control] [get_bd_intf_pins cap_pipe/s_axi_control]
  connect_bd_intf_net -intf_net Conn2 [get_bd_intf_pins s_axi_control1] [get_bd_intf_pins cap_pipe/s_axi_control1]
...
proc create_hier_cell_display_pipe { parentCell nameHier } {
  ...
  set_property -dict [list \
    CONFIG.ADVANCED_PROPERTIES {    __view__ { functional { S07_Buffer { R_SIZE 1024 } S00_Buffer { R_SIZE 1024 } S06_Buffer { R_SIZE 1024 } S05_Buffer { R_SIZE 1024 } S01_Buffer { R_SIZE 1024 } S02_Buffer\
{ R_SIZE 1024 } M00_Buffer { R_SIZE 1024 } S03_Buffer { R_SIZE 1024 } S04_Buffer { R_SIZE 1024 } } }   } \
    CONFIG.NUM_SI {4} \
  ] $smartconnect_vmix_0
...
proc create_hier_cell_audio_pipe { parentCell nameHier } {
  ...
  set_property CONFIG.C_INCLUDE_S2MM {0} $audio_formatter_0
  ...
  set_property CONFIG.C_HDMI_VERSION {0} $hdmi_acr_ctrl_0
...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   CONFIG.DATA_WIDTH {128} \
   CONFIG.CONNECTIONS {MC_0 {read_bw {5} write_bw {5} read_avg_burst {4} write_avg_burst {4}} M02_AXI {read_bw {5} write_bw {5} read_avg_burst {4} write_avg_burst {4}} M00_AXI {read_bw {5} write_bw {5} read_avg_burst {4} write_avg_burst {4}}} \
   CONFIG.DEST_IDS {M02_AXI:0x1c0:M00_AXI:0x180} \
   CONFIG.NOC_PARAMS {} \
  ...
  set_property -dict [ list \
   CONFIG.DATA_WIDTH {128} \
   CONFIG.CONNECTIONS {M02_AXI {read_bw {5} write_bw {5} read_avg_burst {4} write_avg_burst {4}} M00_AXI {read_bw {5} write_bw {5} read_avg_burst {4} write_avg_burst {4}} MC_3 {read_bw {5} write_bw {5} read_avg_burst {4} write_avg_burst {4}}} \
   CONFIG.DEST_IDS {M02_AXI:0x1c0:M00_AXI:0x180} \
   CONFIG.NOC_PARAMS {} \
  ...
  set_property -dict [ list \
   CONFIG.CONNECTIONS {M01_AXI { read_bw {1720} write_bw {1720} read_avg_burst {4} write_avg_burst {4}} MC_1 { read_bw {1720} write_bw {1720} read_avg_burst {4} write_avg_burst {4}}} \
  ...
  set_property -dict [ list \
   CONFIG.CONNECTIONS {M01_AXI { read_bw {1720} write_bw {1720} read_avg_burst {4} write_avg_burst {4}} MC_2 { read_bw {1720} write_bw {1720} read_avg_burst {4} write_avg_burst {4}}} \
   CONFIG.DEST_IDS {M01_AXI:0x140} \
   CONFIG.NOC_PARAMS {} \
   CONFIG.CATEGORY {ps_pcie} \
  ...
  set PS_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:versal_cips:3.3 PS_0 ]
  set_property -dict [list \
    ...
    CONFIG.CPM_CONFIG { \
      ...
      CPM_PCIE0_PF0_BAR1_QDMA_SIZE {128} \
...
{PMC_MIO 26 .. 36}}} \
  ...
  set_property CONFIG.INTERFACE_MODE {SLAVE} $axi_vip_s0
  ...
  set_property CONFIG.C_NUM_PERP_ARESETN {1} $rst_processor_150MHz


  # Create instance: rst_processor_400MHz, and set properties
  set rst_processor_400MHz [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 rst_processor_400MHz ]
  set_property CONFIG.C_NUM_PERP_ARESETN {1} $rst_processor_400MHz
  ...
  set_property CONFIG.NUM_SI {1} $smartconnect_gp2
  ...
  connect_bd_intf_net -intf_net NOC_0_M01_AXI [get_bd_intf_pins NOC_0/M01_AXI] [get_bd_intf_pins smartconnect_0/S00_AXI]
  connect_bd_intf_net -intf_net NOC_0_M02_AXI [get_bd_intf_pins NOC_0/M02_AXI] [get_bd_intf_pins PS_0/NOC_CPM_PCIE_0]
  connect_bd_intf_net -intf_net PS_0_CPM_PCIE_NOC_0 [get_bd_intf_pins NOC_0/S13_AXI] [get_bd_intf_pins PS_0/CPM_PCIE_NOC_0]
  connect_bd_intf_net -intf_net PS_0_CPM_PCIE_NOC_1 [get_bd_intf_pins NOC_0/S14_AXI] [get_bd_intf_pins PS_0/CPM_PCIE_NOC_1]
  connect_bd_intf_net -intf_net PS_0_IF_PMC_NOC_AXI_0 [get_bd_intf_pins NOC_0/S07_AXI] [get_bd_intf_pins PS_0/PMC_NOC_AXI_0]
  connect_bd_intf_net -intf_net PS_0_IF_PS_NOC_CCI_0 [get_bd_intf_pins NOC_0/S00_AXI] [get_bd_intf_pins PS_0/FPD_CCI_NOC_0]
  connect_bd_intf_net -intf_net PS_0_IF_PS_NOC_CCI_1 [get_bd_intf_pins NOC_0/S01_AXI] [get_bd_intf_pins PS_0/FPD_CCI_NOC_1]
  connect_bd_intf_net -intf_net PS_0_IF_PS_NOC_CCI_2 [get_bd_intf_pins NOC_0/S02_AXI] [get_bd_intf_pins PS_0/FPD_CCI_NOC_2]
  connect_bd_intf_net -intf_net PS_0_IF_PS_NOC_CCI_3 [get_bd_intf_pins NOC_0/S03_AXI] [get_bd_intf_pins PS_0/FPD_CCI_NOC_3]
  connect_bd_intf_net -intf_net PS_0_IF_PS_NOC_NCI_0 [get_bd_intf_pins NOC_0/S04_AXI] [get_bd_intf_pins PS_0/FPD_AXI_NOC_0]
  connect_bd_intf_net -intf_net PS_0_IF_PS_NOC_NCI_1 [get_bd_intf_pins NOC_0/S05_AXI] [get_bd_intf_pins PS_0/FPD_AXI_NOC_1]
  connect_bd_intf_net -intf_net PS_0_IF_PS_NOC_RPU_0 [get_bd_intf_pins NOC_0/S06_AXI] [get_bd_intf_pins PS_0/LPD_AXI_NOC_0]
  connect_bd_intf_net -intf_net PS_0_M_AXI_GP2 [get_bd_intf_pins PS_0/M_AXI_LPD] [get_bd_intf_pins smartconnect_gp2/S00_AXI]
  connect_bd_intf_net -intf_net PS_0_PCIE0_GT [get_bd_intf_ports PCIE0_GT_0] [get_bd_intf_pins PS_0/PCIE0_GT]
  connect_bd_intf_net -intf_net audio_pipe_m_axi_mm2s [get_bd_intf_pins NOC_0/S12_AXI] [get_bd_intf_pins audio_pipe/m_axi_mm2s]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets display_pipe_vmix_mm_axi_vid_rd_1] [get_bd_intf_pins NOC_0/S10_AXI] [get_bd_intf_pins axi_perf_mon_0/SLOT_2_AXI]
  connect_bd_intf_net -intf_net gt_refclk0_0_1 [get_bd_intf_ports GT_REFCLK0_D_0] [get_bd_intf_pins PS_0/gt_refclk0]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets mipi_capture_pipe_M00_AXI] [get_bd_intf_pins axi_perf_mon_0/SLOT_5_AXI] [get_bd_intf_pins mipi_capture_pipe/M00_AXI]
  ...
  connect_bd_intf_net -intf_net smartconnect_0_M00_AXI [get_bd_intf_pins pcie_reg_space_0/S00_AXI] [get_bd_intf_pins smartconnect_0/M00_AXI]
  ...
  connect_bd_intf_net -intf_net smartconnect_gp0_M09_AXI [get_bd_intf_pins pcie_reg_space_0/S01_AXI] [get_bd_intf_pins smartconnect_gp0/M09_AXI]
  ...
  connect_bd_intf_net -intf_net smartconnect_gp0_M14_AXI [get_bd_intf_pins mipi_capture_pipe/s_axi_control] [get_bd_intf_pins smartconnect_gp0/M14_AXI]
  connect_bd_intf_net -intf_net smartconnect_gp0_M15_AXI [get_bd_intf_pins mipi_capture_pipe/s_axi_control1] [get_bd_intf_pins smartconnect_gp0/M15_AXI]
  ...
  connect_bd_intf_net -intf_net versal_cips_1_M_AXI_GP0 [get_bd_intf_pins PS_0/M_AXI_FPD] [get_bd_intf_pins smartconnect_gp0/S00_AXI]

  # Create port connections
  connect_bd_net -net Din_1 [get_bd_pins PS_0/LPD_GPIO_o] [get_bd_pins display_pipe/Din] [get_bd_pins mipi_capture_pipe/Din]
  connect_bd_net -net IDT_8T49N241_LOL_IN_1 [get_bd_ports IDT_8T49N241_LOL_IN] [get_bd_pins display_pipe/IDT_8T49N241_LOL_IN]
  connect_bd_net -net PS_0_cpm_pcie_noc_axi0_clk [get_bd_pins NOC_0/aclk14] [get_bd_pins PS_0/cpm_pcie_noc_axi0_clk]
  connect_bd_net -net PS_0_cpm_pcie_noc_axi1_clk [get_bd_pins NOC_0/aclk15] [get_bd_pins PS_0/cpm_pcie_noc_axi1_clk]
  connect_bd_net -net PS_0_noc_cpm_pcie_axi0_clk [get_bd_pins NOC_0/aclk13] [get_bd_pins PS_0/noc_cpm_pcie_axi0_clk]
  connect_bd_net -net PS_0_pl_resetn0 [get_bd_pins PS_0/pl0_resetn] [get_bd_pins audio_pipe/ext_reset_in] [get_bd_pins clk_wiz/resetn] [get_bd_pins rst_processor_150MHz/ext_reset_in] [get_bd_pins rst_processor_400MHz/ext_reset_in] [get_bd_pins rst_processor_pl_100Mhz/ext_reset_in] [get_bd_pins rst_processor_pl_200Mhz/ext_reset_in]
  connect_bd_net -net PS_0_ps_pmc_noc_axi0_clk [get_bd_pins NOC_0/aclk7] [get_bd_pins PS_0/pmc_axi_noc_axi0_clk]
  connect_bd_net -net PS_0_ps_ps_noc_cci_axi0_clk [get_bd_pins NOC_0/aclk0] [get_bd_pins PS_0/fpd_cci_noc_axi0_clk]
  connect_bd_net -net PS_0_ps_ps_noc_cci_axi1_clk [get_bd_pins NOC_0/aclk1] [get_bd_pins PS_0/fpd_cci_noc_axi1_clk]
  connect_bd_net -net PS_0_ps_ps_noc_cci_axi2_clk [get_bd_pins NOC_0/aclk2] [get_bd_pins PS_0/fpd_cci_noc_axi2_clk]
  connect_bd_net -net PS_0_ps_ps_noc_cci_axi3_clk [get_bd_pins NOC_0/aclk3] [get_bd_pins PS_0/fpd_cci_noc_axi3_clk]
  connect_bd_net -net PS_0_ps_ps_noc_nci_axi0_clk [get_bd_pins NOC_0/aclk4] [get_bd_pins PS_0/fpd_axi_noc_axi0_clk]
  connect_bd_net -net PS_0_ps_ps_noc_nci_axi1_clk [get_bd_pins NOC_0/aclk5] [get_bd_pins PS_0/fpd_axi_noc_axi1_clk]
  connect_bd_net -net PS_0_ps_ps_noc_rpu_axi0_clk [get_bd_pins NOC_0/aclk6] [get_bd_pins PS_0/lpd_axi_noc_clk]
  ...
  connect_bd_net -net audio_pipe_irq_mm2s [get_bd_pins PS_0/pl_ps_irq5] [get_bd_pins audio_pipe/irq_mm2s]
  connect_bd_net -net axi_intc_0_irq [get_bd_pins PS_0/pl_ps_irq15] [get_bd_pins axi_intc_0/irq]
  connect_bd_net -net axi_perf_mon_0_interrupt [get_bd_pins PS_0/pl_ps_irq4] [get_bd_pins axi_perf_mon_0/interrupt]
  connect_bd_net -net cap_pipe_Dout [get_bd_ports sensor_gpio_rst] [get_bd_pins mipi_capture_pipe/sensor_gpio_rst]
  connect_bd_net -net clk_wiz_clk_out2 [get_bd_pins NOC_0/aclk12] [get_bd_pins PS_0/m_axi_fpd_aclk] [get_bd_pins audio_pipe/s_axi_lite_aclk] [get_bd_pins clk_wiz/clk_out_100] [get_bd_pins display_pipe/altclk] [get_bd_pins mipi_capture_pipe/s_axi_aclk] [get_bd_pins pcie_reg_space_0/s00_axi_aclk] [get_bd_pins pcie_reg_space_0/s01_axi_aclk] [get_bd_pins rst_processor_pl_100Mhz/slowest_sync_clk] [get_bd_pins smartconnect_0/aclk] [get_bd_pins smartconnect_gp0/aclk]
  connect_bd_net -net clk_wiz_clk_out3 [get_bd_pins NOC_0/aclk9] [get_bd_pins axi_perf_mon_0/slot_5_axi_aclk] [get_bd_pins clk_wiz/clk_out_200] [get_bd_pins mipi_capture_pipe/video_clk] [get_bd_pins rst_processor_pl_200Mhz/slowest_sync_clk] [get_bd_pins smartconnect_gp0/aclk2]
  connect_bd_net -net clk_wiz_clk_out_400 [get_bd_pins axi_perf_mon_0/core_aclk] [get_bd_pins axi_perf_mon_0/slot_4_axi_aclk] [get_bd_pins axi_perf_mon_0/slot_6_axi_aclk] [get_bd_pins clk_wiz/clk_out_400] [get_bd_pins rst_processor_400MHz/slowest_sync_clk]
  connect_bd_net -net display_pipe_TX_EN_OUT [get_bd_ports TX_EN_OUT] [get_bd_pins display_pipe/TX_EN_OUT]
  connect_bd_net -net display_pipe_iic2intc_irpt [get_bd_pins PS_0/pl_ps_irq3] [get_bd_pins display_pipe/iic2intc_irpt]
  connect_bd_net -net display_pipe_irq [get_bd_pins PS_0/pl_ps_irq0] [get_bd_pins display_pipe/irq]
  connect_bd_net -net display_pipe_irq1 [get_bd_pins PS_0/pl_ps_irq1] [get_bd_pins display_pipe/irq1]
  ...
  connect_bd_net -net display_pipe_vmix_intr [get_bd_pins PS_0/pl_ps_irq2] [get_bd_pins display_pipe/vmix_intr]
  connect_bd_net -net hdmi_clk_1 [get_bd_pins audio_pipe/hdmi_clk] [get_bd_pins display_pipe/tx_tmds_clk]
  connect_bd_net -net mipi_capture_pipe_csirxss_csi_irq [get_bd_pins PS_0/pl_ps_irq6] [get_bd_pins mipi_capture_pipe/csirxss_csi_irq]
  connect_bd_net -net mipi_capture_pipe_frm_buf_irq [get_bd_pins PS_0/pl_ps_irq8] [get_bd_pins mipi_capture_pipe/frm_buf_irq]
  connect_bd_net -net mipi_capture_pipe_iic2intc_irpt [get_bd_pins PS_0/pl_ps_irq7] [get_bd_pins mipi_capture_pipe/iic2intc_irpt]
  ...
  connect_bd_net -net net_clk_wiz_locked [get_bd_pins clk_wiz/locked] [get_bd_pins rst_processor_150MHz/dcm_locked] [get_bd_pins rst_processor_400MHz/dcm_locked] [get_bd_pins rst_processor_pl_100Mhz/dcm_locked] [get_bd_pins rst_processor_pl_200Mhz/dcm_locked]
  connect_bd_net -net net_mb_ss_0_clk_out2 [get_bd_pins NOC_0/aclk8] [get_bd_pins PS_0/m_axi_lpd_aclk] [get_bd_pins axi_intc_0/s_axi_aclk] [get_bd_pins axi_perf_mon_0/s_axi_aclk] [get_bd_pins axi_perf_mon_0/slot_0_axi_aclk] [get_bd_pins axi_perf_mon_0/slot_1_axi_aclk] [get_bd_pins axi_perf_mon_0/slot_2_axi_aclk] [get_bd_pins axi_perf_mon_0/slot_3_axi_aclk] [get_bd_pins axi_vip_s0/aclk] [get_bd_pins clk_wiz/clk_out_150] [get_bd_pins display_pipe/s_axis_aclk] [get_bd_pins rst_processor_150MHz/slowest_sync_clk] [get_bd_pins smartconnect_gp0/aclk1] [get_bd_pins smartconnect_gp2/aclk]
  ...
  connect_bd_net -net net_mb_ss_0_s_axi_aclk [get_bd_pins PS_0/pl0_ref_clk] [get_bd_pins clk_wiz/clk_in1]
  connect_bd_net -net pcie_reg_space_0_IRQ1_to_Host [get_bd_pins PS_0/cpm_irq0] [get_bd_pins pcie_reg_space_0/IRQ1_to_Host]
  connect_bd_net -net pcie_reg_space_0_IRQ1_to_PS [get_bd_pins PS_0/pl_ps_irq9] [get_bd_pins pcie_reg_space_0/IRQ1_to_PS]
  connect_bd_net -net pcie_reg_space_0_IRQ2_to_PS [get_bd_pins PS_0/pl_ps_irq10] [get_bd_pins pcie_reg_space_0/IRQ2_to_PS]
  connect_bd_net -net pcie_reg_space_0_IRQ3_to_PS [get_bd_pins PS_0/pl_ps_irq11] [get_bd_pins pcie_reg_space_0/IRQ3_to_PS]
  connect_bd_net -net pcie_reg_space_0_IRQ4_to_PS [get_bd_pins PS_0/pl_ps_irq12] [get_bd_pins pcie_reg_space_0/IRQ4_to_PS]
  connect_bd_net -net rst_processor_1_100M_peripheral_aresetn [get_bd_pins audio_pipe/s_axi_lite_aresetn] [get_bd_pins display_pipe/ARESETN] [get_bd_pins mipi_capture_pipe/s_axi_aresetn] [get_bd_pins pcie_reg_space_0/s00_axi_aresetn] [get_bd_pins pcie_reg_space_0/s01_axi_aresetn] [get_bd_pins rst_processor_pl_100Mhz/peripheral_aresetn] [get_bd_pins smartconnect_0/aresetn]
  connect_bd_net -net rst_processor_1_150M_interconnect_aresetn [get_bd_pins axi_perf_mon_0/s_axi_aresetn] [get_bd_pins axi_perf_mon_0/slot_0_axi_aresetn] [get_bd_pins axi_perf_mon_0/slot_1_axi_aresetn] [get_bd_pins axi_perf_mon_0/slot_2_axi_aresetn] [get_bd_pins axi_perf_mon_0/slot_3_axi_aresetn] [get_bd_pins axi_vip_s0/aresetn] [get_bd_pins display_pipe/sc_aresetn] [get_bd_pins rst_processor_150MHz/interconnect_aresetn] [get_bd_pins smartconnect_gp2/aresetn]
  connect_bd_net -net rst_processor_400MHz_peripheral_aresetn [get_bd_pins axi_perf_mon_0/core_aresetn] [get_bd_pins axi_perf_mon_0/slot_4_axi_aresetn] [get_bd_pins axi_perf_mon_0/slot_6_axi_aresetn] [get_bd_pins rst_processor_400MHz/peripheral_aresetn]
  connect_bd_net -net rst_processor_pl_200Mhz_peripheral_aresetn [get_bd_pins axi_perf_mon_0/slot_5_axi_aresetn] [get_bd_pins mipi_capture_pipe/video_rst_n] [get_bd_pins rst_processor_pl_200Mhz/peripheral_aresetn]
  ...
  assign_bd_address -offset 0x050000000000 -range 0x000180000000 -target_address_space [get_bd_addr_spaces PS_0/CPM_PCIE_NOC_0] [get_bd_addr_segs NOC_0/S13_AXI/C1_DDR_CH1x2] -force
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces PS_0/CPM_PCIE_NOC_0] [get_bd_addr_segs NOC_0/S13_AXI/C1_DDR_LOW0x2] -force
  assign_bd_address -offset 0x020140000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces PS_0/CPM_PCIE_NOC_0] [get_bd_addr_segs pcie_reg_space_0/S00_AXI/S00_AXI_reg] -force
  assign_bd_address -offset 0x050000000000 -range 0x000180000000 -target_address_space [get_bd_addr_spaces PS_0/CPM_PCIE_NOC_1] [get_bd_addr_segs NOC_0/S14_AXI/C2_DDR_CH1x2] -force
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces PS_0/CPM_PCIE_NOC_1] [get_bd_addr_segs NOC_0/S14_AXI/C2_DDR_LOW0x2] -force
  assign_bd_address -offset 0x020140000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces PS_0/CPM_PCIE_NOC_1] [get_bd_addr_segs pcie_reg_space_0/S00_AXI/S00_AXI_reg] -force
  assign_bd_address -offset 0x050000000000 -range 0x000180000000 -target_address_space [get_bd_addr_spaces PS_0/FPD_AXI_NOC_0] [get_bd_addr_segs NOC_0/S04_AXI/C0_DDR_CH1x2] -force
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces PS_0/FPD_AXI_NOC_0] [get_bd_addr_segs NOC_0/S04_AXI/C0_DDR_LOW0x2] -force
  assign_bd_address -offset 0x020000000000 -range 0x000100000000 -target_address_space [get_bd_addr_spaces PS_0/FPD_AXI_NOC_0] [get_bd_addr_segs ai_engine_0/S00_AXI/AIE_ARRAY_0] -force
  assign_bd_address -offset 0x050000000000 -range 0x000180000000 -target_address_space [get_bd_addr_spaces PS_0/FPD_AXI_NOC_1] [get_bd_addr_segs NOC_0/S05_AXI/C1_DDR_CH1x2] -force
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces PS_0/FPD_AXI_NOC_1] [get_bd_addr_segs NOC_0/S05_AXI/C1_DDR_LOW0x2] -force
  assign_bd_address -offset 0x020000000000 -range 0x000100000000 -target_address_space [get_bd_addr_spaces PS_0/FPD_AXI_NOC_1] [get_bd_addr_segs ai_engine_0/S00_AXI/AIE_ARRAY_0] -force
  assign_bd_address -offset 0x050000000000 -range 0x000180000000 -target_address_space [get_bd_addr_spaces PS_0/FPD_CCI_NOC_0] [get_bd_addr_segs NOC_0/S00_AXI/C0_DDR_CH1x2] -force
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces PS_0/FPD_CCI_NOC_0] [get_bd_addr_segs NOC_0/S00_AXI/C0_DDR_LOW0x2] -force
  assign_bd_address -offset 0x020000000000 -range 0x000100000000 -target_address_space [get_bd_addr_spaces PS_0/FPD_CCI_NOC_0] [get_bd_addr_segs ai_engine_0/S00_AXI/AIE_ARRAY_0] -force
  assign_bd_address -offset 0x050000000000 -range 0x000180000000 -target_address_space [get_bd_addr_spaces PS_0/FPD_CCI_NOC_1] [get_bd_addr_segs NOC_0/S01_AXI/C1_DDR_CH1x2] -force
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces PS_0/FPD_CCI_NOC_1] [get_bd_addr_segs NOC_0/S01_AXI/C1_DDR_LOW0x2] -force
  assign_bd_address -offset 0x020000000000 -range 0x000100000000 -target_address_space [get_bd_addr_spaces PS_0/FPD_CCI_NOC_1] [get_bd_addr_segs ai_engine_0/S00_AXI/AIE_ARRAY_0] -force
  assign_bd_address -offset 0x050000000000 -range 0x000180000000 -target_address_space [get_bd_addr_spaces PS_0/FPD_CCI_NOC_2] [get_bd_addr_segs NOC_0/S02_AXI/C2_DDR_CH1x2] -force
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces PS_0/FPD_CCI_NOC_2] [get_bd_addr_segs NOC_0/S02_AXI/C2_DDR_LOW0x2] -force
  assign_bd_address -offset 0x020000000000 -range 0x000100000000 -target_address_space [get_bd_addr_spaces PS_0/FPD_CCI_NOC_2] [get_bd_addr_segs ai_engine_0/S00_AXI/AIE_ARRAY_0] -force
  assign_bd_address -offset 0x050000000000 -range 0x000180000000 -target_address_space [get_bd_addr_spaces PS_0/FPD_CCI_NOC_3] [get_bd_addr_segs NOC_0/S03_AXI/C3_DDR_CH1x2] -force
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces PS_0/FPD_CCI_NOC_3] [get_bd_addr_segs NOC_0/S03_AXI/C3_DDR_LOW0x2] -force
  assign_bd_address -offset 0x020000000000 -range 0x000100000000 -target_address_space [get_bd_addr_spaces PS_0/FPD_CCI_NOC_3] [get_bd_addr_segs ai_engine_0/S00_AXI/AIE_ARRAY_0] -force
  assign_bd_address -offset 0x050000000000 -range 0x000180000000 -target_address_space [get_bd_addr_spaces PS_0/LPD_AXI_NOC_0] [get_bd_addr_segs NOC_0/S06_AXI/C2_DDR_CH1x2] -force
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces PS_0/LPD_AXI_NOC_0] [get_bd_addr_segs NOC_0/S06_AXI/C2_DDR_LOW0x2] -force
  assign_bd_address -offset 0x020000000000 -range 0x000100000000 -target_address_space [get_bd_addr_spaces PS_0/LPD_AXI_NOC_0] [get_bd_addr_segs ai_engine_0/S00_AXI/AIE_ARRAY_0] -force
  assign_bd_address -offset 0xA40F0000 -range 0x00010000 -target_address_space [get_bd_addr_spaces PS_0/M_AXI_FPD] [get_bd_addr_segs mipi_capture_pipe/cap_pipe/ISPPipeline_accel_0/s_axi_CTRL/Reg] -force
  assign_bd_address -offset 0xA4200000 -range 0x00010000 -target_address_space [get_bd_addr_spaces PS_0/M_AXI_FPD] [get_bd_addr_segs audio_pipe/audio_formatter_0/s_axi_lite/reg0] -force
  assign_bd_address -offset 0xA4070000 -range 0x00010000 -target_address_space [get_bd_addr_spaces PS_0/M_AXI_FPD] [get_bd_addr_segs mipi_capture_pipe/mipi_csi_rx_ss/axi_iic_1_sensor/S_AXI/Reg] -force
  assign_bd_address -offset 0xA5000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces PS_0/M_AXI_FPD] [get_bd_addr_segs axi_intc_0/S_AXI/Reg] -force
  assign_bd_address -offset 0xA4050000 -range 0x00010000 -target_address_space [get_bd_addr_spaces PS_0/M_AXI_FPD] [get_bd_addr_segs axi_perf_mon_0/S_AXI/Reg] -force
  assign_bd_address -offset 0xA40C0000 -range 0x00010000 -target_address_space [get_bd_addr_spaces PS_0/M_AXI_FPD] [get_bd_addr_segs mipi_capture_pipe/cap_pipe/extractEFrames_accel_0/s_axi_control/Reg] -force
  assign_bd_address -offset 0xA4010000 -range 0x00010000 -target_address_space [get_bd_addr_spaces PS_0/M_AXI_FPD] [get_bd_addr_segs display_pipe/hdmi_tx_phy/fmch_axi_iic/S_AXI/Reg] -force
  assign_bd_address -offset 0xA4210000 -range 0x00010000 -target_address_space [get_bd_addr_spaces PS_0/M_AXI_FPD] [get_bd_addr_segs audio_pipe/hdmi_acr_ctrl_0/axi/Reg] -force
  assign_bd_address -offset 0xA4000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces PS_0/M_AXI_FPD] [get_bd_addr_segs display_pipe/hdmi_tx_phy/hdmi_gt_controller_1/axi4lite/Reg] -force
  assign_bd_address -offset 0xA40E0000 -range 0x00010000 -target_address_space [get_bd_addr_spaces PS_0/M_AXI_FPD] [get_bd_addr_segs mipi_capture_pipe/cap_pipe/hdrmerge_accel_0/s_axi_control/Reg] -force
  assign_bd_address -offset 0xA4060000 -range 0x00010000 -target_address_space [get_bd_addr_spaces PS_0/M_AXI_FPD] [get_bd_addr_segs mipi_capture_pipe/mipi_csi_rx_ss/mipi_csi2_rx_subsyst_0/csirxss_s_axi/Reg] -force
  assign_bd_address -offset 0xA4100000 -range 0x00010000 -target_address_space [get_bd_addr_spaces PS_0/M_AXI_FPD] [get_bd_addr_segs pcie_reg_space_0/S01_AXI/S01_AXI_reg] -force
  assign_bd_address -offset 0xA40D0000 -range 0x00010000 -target_address_space [get_bd_addr_spaces PS_0/M_AXI_FPD] [get_bd_addr_segs mipi_capture_pipe/cap_pipe/v_frmbuf_wr_0/s_axi_CTRL/Reg] -force
  assign_bd_address -offset 0xA4020000 -range 0x00020000 -target_address_space [get_bd_addr_spaces PS_0/M_AXI_FPD] [get_bd_addr_segs display_pipe/v_hdmi_tx_ss_0/S_AXI_CPU_IN/Reg] -force
  assign_bd_address -offset 0xA4040000 -range 0x00010000 -target_address_space [get_bd_addr_spaces PS_0/M_AXI_FPD] [get_bd_addr_segs display_pipe/v_mix_0/s_axi_CTRL/Reg] -force
  assign_bd_address -offset 0xA4080000 -range 0x00040000 -target_address_space [get_bd_addr_spaces PS_0/M_AXI_FPD] [get_bd_addr_segs mipi_capture_pipe/cap_pipe/v_proc_ss_0/s_axi_ctrl/Reg] -force
  assign_bd_address -offset 0x90000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces PS_0/M_AXI_LPD] [get_bd_addr_segs axi_vip_s0/S_AXI/Reg] -force
  assign_bd_address -offset 0x050000000000 -range 0x000180000000 -target_address_space [get_bd_addr_spaces PS_0/PMC_NOC_AXI_0] [get_bd_addr_segs NOC_0/S07_AXI/C3_DDR_CH1x2] -force
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces PS_0/PMC_NOC_AXI_0] [get_bd_addr_segs NOC_0/S07_AXI/C3_DDR_LOW0x2] -force
  assign_bd_address -offset 0xE0000000 -range 0x10000000 -target_address_space [get_bd_addr_spaces PS_0/PMC_NOC_AXI_0] [get_bd_addr_segs PS_0/NOC_CPM_PCIE_0/pspmc_0_psv_noc_pcie_0] -force
  assign_bd_address -offset 0x000600000000 -range 0x000200000000 -target_address_space [get_bd_addr_spaces PS_0/PMC_NOC_AXI_0] [get_bd_addr_segs PS_0/NOC_CPM_PCIE_0/pspmc_0_psv_noc_pcie_1] -force
  assign_bd_address -offset 0x008000000000 -range 0x004000000000 -target_address_space [get_bd_addr_spaces PS_0/PMC_NOC_AXI_0] [get_bd_addr_segs PS_0/NOC_CPM_PCIE_0/pspmc_0_psv_noc_pcie_2] -force
  assign_bd_address -offset 0x020000000000 -range 0x000100000000 -target_address_space [get_bd_addr_spaces PS_0/PMC_NOC_AXI_0] [get_bd_addr_segs ai_engine_0/S00_AXI/AIE_ARRAY_0] -force
  assign_bd_address -offset 0x050000000000 -range 0x000180000000 -target_address_space [get_bd_addr_spaces audio_pipe/audio_formatter_0/m_axi_mm2s] [get_bd_addr_segs NOC_0/S12_AXI/C0_DDR_CH1x2] -force
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces audio_pipe/audio_formatter_0/m_axi_mm2s] [get_bd_addr_segs NOC_0/S12_AXI/C0_DDR_LOW0x2] -force
  ...
  assign_bd_address -offset 0x050000000000 -range 0x000180000000 -target_address_space [get_bd_addr_spaces mipi_capture_pipe/cap_pipe/v_frmbuf_wr_0/Data_m_axi_mm_video] [get_bd_addr_segs NOC_0/S11_AXI/C3_DDR_CH1x2] -force
  ...
  exclude_bd_addr_seg -offset 0xE0000000 -range 0x10000000 -target_address_space [get_bd_addr_spaces PS_0/FPD_CCI_NOC_0] [get_bd_addr_segs PS_0/NOC_CPM_PCIE_0/pspmc_0_psv_noc_pcie_0]
  exclude_bd_addr_seg -offset 0x000600000000 -range 0x000200000000 -target_address_space [get_bd_addr_spaces PS_0/FPD_CCI_NOC_0] [get_bd_addr_segs PS_0/NOC_CPM_PCIE_0/pspmc_0_psv_noc_pcie_1]
  exclude_bd_addr_seg -offset 0x008000000000 -range 0x004000000000 -target_address_space [get_bd_addr_spaces PS_0/FPD_CCI_NOC_0] [get_bd_addr_segs PS_0/NOC_CPM_PCIE_0/pspmc_0_psv_noc_pcie_2]
