...
PLNX_DIR = petalinux/xilinx-vck190-pcie-trd
...
OVERLAY_UTILS = $(OVERLAY_DIR)/$(OVERLAY)/utils
...
$(PLNX_WIC): $(PLNX_DIR) $(OVERLAY_XSA) $(OVERLAY_XCLBIN)
	...
	@cp -r $(OVERLAY_APP_DIR)/* $(PLNX_DIR)/project-spec/meta-vck190-pcie-trd/recipes-apps
	@mkdir -p $(PLNX_DIR)/project-spec/meta-vck190-pcie-trd/recipes-utils
	@cp -r $(OVERLAY_UTILS)/* $(PLNX_DIR)/project-spec/meta-vck190-pcie-trd/recipes-utils
