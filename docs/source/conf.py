...
edit_on_github_project = 'Xilinx/vck190-pcie-trd'
...
htmlhelp_basename = 'versal_pcie_trd.tex'
...
latex_documents = [
    (master_doc, 'versal_pcie_trd.tex', 'Versal PCIe TRD',
     'Xilinx', 'manual'),
]
...
man_pages = [
    (master_doc, 'versal_base_trd', 'Versal PCIe TRD',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'versal_base_trd', 'Versal PCIe TRD',
     author, 'Xilinx', 'The Versal PCIe TRD consists of PCI express usecases targetting the VCK190 evaluation board.',
     'Miscellaneous'),
]
