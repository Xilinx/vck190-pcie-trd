...
The processing pipeline consists of 2D convolution filter in PL along with a data mover (DM). 
...
The Vitis™ tool uses the .xo and integrates the IPs into the platform.
